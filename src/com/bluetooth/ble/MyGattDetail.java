...
//            }
    ...
    private static BluetoothLeService.OnDataAvailableListener mOnDataAvailable = new com.bluetooth.ble.BluetoothLeService.OnDataAvailableListener(){
	 ...
	 */
	 ...
	 private final ExpandableListView.OnChildClickListener servicesListClickListner =
	    ...
	    public static void read()
	    {
	    	...
	    	//mBluetoothLeService.readCharacteristic(target_chara);            //此句不能加上，否则会出现闪退
	    }
}
